...
INSERT INTO `driver` (`driver_id`, `name`, `phone_number`, `vehile_num`) VALUES
  (101, 'Василий Павлов', '+7 (920) 232-32-34', 'ТА 512 А'),
  (102, 'Сергей Иванов', '+7 (965) 453-23-42', 'ЕК 777 Х'),
  (103, 'Валентин Писаренко', '+7 (915) 112-34-45', 'ЕУ 312 Р'),
  (104, 'Александр Фадеев', '+7 (903) 544-23-53', 'ЕН 112 К');
